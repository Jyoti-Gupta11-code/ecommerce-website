      ...
      <div className="my-10 flex flex-col md:flex-row gap-16">
        ...
        <div className="flex flex-col justify-center gap-6 md:w-2/4 text-gray-600">
          <p>
            ...
            the way people shop online. Our journey began with a simple idea: to create 
            a platform that offers a wide range of products at affordable prices.
          </p>
          ...
          <p>
            ...
            and accessories to electronics and home essentials, we have it all.
          </p>
          ...
          <p>
            ...
            and confidence. We're dedicated to providing exceptional service and ensuring 
            that every shopping experience is seamless and enjoyable.
          </p>
        </div>
